...
import com.emergency.util.CustomHttpClient;
import com.emergency.util.ListAdapter;
...
//		splashscreen
        ...
        new GetData()
                .execute("http://192.168.3.50/e_place/android/OutputTambalBan.php");
    }
        ...
        protected String doInBackground(String... params) {
            try {
                Content = CustomHttpClient.executeHttpPost(
                        "http://192.168.3.50/e_place/android/OutputTambalBan.php",
                        data);
            ...
            if (Error != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < menuitemArray.length(); i++) {
                        ...
                        /*Gambar[i] = "http://192.168.1.101/nongkinongki/gambar/"
